...
The notebook `dpsgd_baseline.ipynb` trains networks and saves them in a `./networks` directory. The DP-SGD training is based on the [Opacus tutorial](https://opacus.ai/tutorials/building_image_classifier). 
